    ...
    return (
      <div className="text-center px-6 py-8 bg-gray-900 text-white rounded-xl shadow-lg max-w-2xl mx-auto">
        ...
        <ul className="text-left text-sm text-gray-300 mb-6 space-y-2">
          ...
          <li>📈 Торговая рекомендация: Точка входа, Тейк, Стоп</li>
        ...
        <ul className="text-left text-sm text-gray-300 mb-6 space-y-2">
          <li><b>Новости. Поддержка в канале</b> ...</li>
          <li><b>Актуальные торговые стратегии</b>...</li>
          <li><b>Оформить подписку</b>....</li>
        </ul>
      </div>
    );
  }
